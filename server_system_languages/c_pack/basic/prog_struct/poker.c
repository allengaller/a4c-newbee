...
void read_cards(void)
{
    ...
    for(rank = 0; suit < NUM_RANKS; rank++){
        num_in_rank[rank] = 0;
...
/*******************************************************************************
 *analyse_hand: Dtermines whether the hand contains a straight, a flush, four- * 
 *              of-a-kind, and/or a three-of-a-kind; determines the numbers of * 
...
/*******************************************************************************
 *print_result: Prints the classification of the hand, based on the value of   * 
 *              the external varibles straight, flush, four, three, and pairs. * 
 *******************************************************************************/
void print_result(void)
{
